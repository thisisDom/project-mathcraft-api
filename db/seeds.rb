...
PlayersResource.create({player_id: 1, resource_id: 1, quantity: 10})
PlayersResource.create({player_id: 1, resource_id: 2, quantity: 5})
PlayersResource.create({player_id: 1, resource_id: 3, quantity: 69})
