...
PlayersResource.create({player: player, resource: r1, quantity: 10})
PlayersResource.create({player: player, resource: r2, quantity: 5})
PlayersResource.create({player: player, resource: r3, quantity: 69})
